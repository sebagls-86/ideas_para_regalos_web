    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <p className={styles.description}>
          Bienvenido a Ideas para Regalos. Al acceder a su cuenta, usted se
          compromete a seguir nuestras políticas y normas, que están destinadas
          a proteger tanto tus derechos como los de otros usuarios. Recomendamos
          que lea detenidamente nuestros Términos y Condiciones para que esté
          plenamente informado sobre sus obligaciones y derechos al utilizar
          nuestra plataforma.
        </p>

        <div className={styles.titulo_}>1. Aceptación de los Términos</div>
        <p className="mb-2">
          Al acceder a nuestro sitio web, acepta estar sujeto a estos Términos
          de Uso y a todas las leyes y regulaciones aplicables. Si no está de
          acuerdo con alguno de estos términos, tiene prohibido usar o acceder a
          este sitio.
        </p>
        ...
        <p className="mb-2">
          ...
          deba registrarse y crear una cuenta. Se compromete a proporcionar
        ...
        <p className="mb-2">
          ...
          datos. Al utilizar nuestro sitio web, acepta los términos y
          condiciones establecidos, que tiene como objetivo garantizar la
          seguridad y confidencialidad de su información. Le recomendamos leerla
          detenidamente para comprender cómo manejamos tus datos y cuáles son
          sus derechos en relación a la protección de la privacidad.
        </p>
        <div className={styles.titulo_}>5. Uso Aceptable</div>
        <p className="mb-2">
          Se compromete a utilizar nuestro sitio web de manera legal y
        ...
        <p className="mb-2">
          Acepta indemnizar y mantener indemne a Ideas para Regalos y a sus
          afiliados, empleados, agentes, socios y licenciantes, de cualquier
          reclamo o demanda, incluyendo honorarios razonables de abogados,
          realizados por cualquier tercero debido a o como resultado de su
          violación de estos Términos de Uso o su violación de cualquier ley o
