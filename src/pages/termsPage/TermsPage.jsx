    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <p className={styles.sub_title}>
          Bienvenido a Ideas para Regalos. Al iniciar sesión en tu cuenta,
          aceptás estar sujeto a nuestros
          <br></br> Términos y Condiciones.
        </p>
        ...
        <div className={styles.description}>1. Aceptación de los Términos</div>
        <p className="mb-2">
          Al acceder a nuestro sitio web, usted acepta estar sujeto a estos
          Términos de Uso y a todas las leyes y regulaciones aplicables. Si no
          está de acuerdo con alguno de estos términos, tiene prohibido usar o
        ...
        <p className="mb-2">
          ...
          momento de su publicación en el sitio web. Es su responsabilidad
          revisar estos términos periódicamente para estar informado de
          cualquier cambio.
        </p>

        <div className={styles.description}>3. Registro de Usuario</div>
        <p className="mb-2">
          Para utilizar ciertos servicios de nuestro sitio web, es posible que
          deba registrarse y crear una cuenta. Usted se compromete a
          proporcionar información precisa y completa durante el proceso de
          registro y a actualizar dicha información según sea necesario.
        </p>
        <div className={styles.description}>4. Privacidad</div>
        <p className="mb-2">
          El uso de su información personal está regulado por nuestra Política
          de Privacidad, que puede encontrar en [enlace a la Política de
          Privacidad]. Al utilizar nuestro sitio web, usted acepta los términos
          de nuestra Política de Privacidad.
        </p>
        <div className={styles.description}>5. Uso Aceptable</div>
        <p className="mb-2">
          Usted se compromete a utilizar nuestro sitio web de manera legal y
          respetuosa. No podrá utilizar el sitio web para: Publicar o transmitir
        ...
        <div className={styles.description}>6. Propiedad Intelectual</div>
        <p className="mb-2">
        ...
        <p className="mb-2">
          ...
          uso o alteración de sus transmisiones o contenido.
        </p>
        <div className={styles.description}>8. Indemnización</div>
        <p className="mb-2">
          Usted acepta indemnizar y mantener indemne a [Nombre del Sitio Web] y
        ...
        <div className={styles.description}>9. Terminación</div>
        <p className="mb-2">
          Nos reservamos el derecho de terminar o suspender su cuenta y acceso
        ...
        <div className={styles.description}>10. Ley Aplicable</div>
        <p className="mb-2">
        ...
        <div className={styles.description}>11. Contacto</div>
        <p className="mb-2">
          Si tiene alguna pregunta sobre estos Términos de Uso, por favor
          contáctenos en: Ideas para Regalos Correo electrónico:
        ...
        <p className="mb-2">
          ...
          tenga una experiencia positiva y enriquecedora.
        </p>
      </div>
    </>
  );
